...
export default function Login() {
 ...
 <button className="w-12 h-12 border border-gray-300 rounded-lg flex items-center justify-center text-gray-600 hover:bg-gray-100 transition">
        ...
        <div className="bg-gradient-to-br from-[#5a67d8] to-[#4c1d95] text-white flex flex-col justify-center items-center px-12 py-10 rounded-l-[120px]">
          ...
          <Link
            to="/register"
            className="mt-12 border-2 border-white px-12 py-3 rounded-lg font-semibold tracking-wide hover:bg-white hover:text-purple-700 transition duration-300"
          >
            SIGN UP
          </Link>
        </div>
